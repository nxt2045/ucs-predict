...
"""
clean
D:\Program\Miniconda3\envs\env_jdata\python.exe D:/Project/JData-UCS/ucsmodel_1/prepare.py
>> 开始替换数据
> copying jdata_action.csv
复制完成！
> Null in  jdata_user.csv
<class 'pandas.core.frame.DataFrame'>
RangeIndex: 1608707 entries, 0 to 1608706
Data columns (total 9 columns):
user_id        1608707 non-null object
age            1606520 non-null object
sex            1608036 non-null object
user_reg_tm    1608707 non-null object
user_lv_cd     1608707 non-null object
city_level     1607283 non-null object
province       1607668 non-null object
city           1607668 non-null object
county         1607668 non-null object
dtypes: object(9)
memory usage: 110.5+ MB
None
  user_id  age  sex            user_reg_tm user_lv_cd city_level province city county
0  381581  NaN  NaN  2018-01-21 21:03:37.0          1        NaN      NaN  NaN    NaN
0  381581  NaN  NaN  2018-01-21 21:03:37.0          1        NaN      NaN  NaN    NaN
0  381581  NaN  NaN  2018-01-21 21:03:37.0          1        NaN      NaN  NaN    NaN
0  381581  NaN  NaN  2018-01-21 21:03:37.0          1        NaN      NaN  NaN    NaN
0  381581  NaN  NaN  2018-01-21 21:03:37.0          1        NaN      NaN  NaN    NaN
> filling jdata_user.csv
读取完成！
保存完成！
> copying jdata_product.csv
复制完成！
> Null in  jdata_shop.csv
<class 'pandas.core.frame.DataFrame'>
RangeIndex: 10399 entries, 0 to 10398
Data columns (total 7 columns):
vender_id      10399 non-null object
shop_id        10399 non-null object
fans_num       10399 non-null object
vip_num        10399 non-null object
shop_reg_tm    9754 non-null object
cate           8209 non-null object
shop_score     10399 non-null object
dtypes: object(7)
memory usage: 568.8+ KB
None
  vender_id shop_id fans_num vip_num            shop_reg_tm cate shop_score
0      3666    5330        0       0                    NaN  NaN        0.0
0      3666    5330        0       0                    NaN  NaN        0.0
1      7288    1047      762    1017  2014-11-03 10:45:58.0  NaN       -1.0
2      4674    2265     2294   21925  2014-10-17 18:25:58.0  NaN       -1.0
3      5217    3200     9527   53231  2014-10-25 09:17:59.0  NaN       -1.0
> filling jdata_shop.csv
保存完成！
> copying jdata_comment.csv
复制完成！
<< 数据替换完成！
